...
interface CWAPredictionPageProps {
...
const calculateCWAPrediction = (behaviorData: typeof behaviorMetrics, scheduleData: ScheduleSession[]) => {
  const weights = {
    systemUsage: 0.15,
    studyBehavior: 0.35,
...
const identifyRiskFactors = (behaviorData: typeof behaviorMetrics) => {
  const risks = []
...
const generateRecommendations = (behaviorData: typeof behaviorMetrics) => {
...
export default function CWAPredictionPage({ scheduleData, userCourses, theme }: CWAPredictionPageProps) {
  ...
  return (
    <div className="h-full overflow-y-auto bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="p-6 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                {Object.entries(prediction.componentScores).map(([component, score]) => {
                  ...
                  const Icon = icons[component as keyof typeof icons]
                  const labels = {
                  ...
                  return (
                    <div key={component} className="p-4 rounded-lg border">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                          <div className="font-semibold">{labels[component as keyof typeof labels]}</div>
        ...
        {showDetailedAnalysis && <DetailedBehaviorAnalysis behaviorData={behaviorData} theme={theme} />}
      </div>
    </div>
  )
}
// Detailed Behavior Analysis Component
function DetailedBehaviorAnalysis({ behaviorData, theme }: { behaviorData: typeof behaviorMetrics; theme: Theme }) {
  return (
    <div className="space-y-6">
