...
const sampleQuizResults = [
  {
    ...
    courseCode: "MATH301",
    quizTitle: "Derivatives Practice",
    score: 85,
    maxScore: 100,
    percentage: 85,
    difficulty: "Medium",
...
// Enhanced CWA calculation including quiz performance
const calculateEnhancedCWA = (
  behaviorData,
  quizMetrics,
) => {
...
export default function EnhancedCWAWithQuizzes({
  scheduleData,
  userCourses,
    ...
    const loadQuizData = async () => {
      ...
      try {
        ...
        if (quizData && quizData.quizResults) {
          ...
          console.log('No quiz results found, using sample data')
          setRealQuizResults(sampleQuizResults)
        }
      } catch (error) {
        console.error('Error loading quiz data:', error)
        setQuizDataError('Failed to load quiz data')
        setRealQuizResults(sampleQuizResults) // Fallback to sample data
      } finally {
  ...
  // Use real quiz data if available, otherwise use provided or sample data
  const effectiveQuizResults = realQuizResults.length > 0 ? realQuizResults : quizResults
  ...
  const prediction = useMemo(
    () => calculateEnhancedCWA(currentBehaviorData, quizMetrics),
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-3xl font-bold mb-2">Enhanced CWA Prediction</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border p-8 text-center">
            ...
            <div className="text-sm opacity-75 mb-4">Enhanced CWA Prediction</div>
