...
const SchedulePage = () => {
  ...
  useEffect(() => {
    ...
    if (storedUserFullName) {
      setUserFullName(JSON.parse(storedUserFullName));
    }
  ...
  const avatarText = userFullName.firstname && userFullName.lastname
    ? `${userFullName.firstname[0]}${userFullName.lastname[0]}`.toUpperCase()
    : 'U';
      ...
      <div className="dashboard-content">
        <div className="dashboard-header">
          ...
          <div className="user-profile">
            <span className="user-name">{`${userFullName.firstname} ${userFullName.lastname}` || 'Guest'}</span>
